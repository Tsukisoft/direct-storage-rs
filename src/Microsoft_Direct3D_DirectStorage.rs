...
pub mod Direct3D {
    pub mod DirectStorage {
        ...
        impl core::ops::Deref for IDStorageCompressionCodec {
            type Target = windows_core::IUnknown;
            fn deref(&self) -> &Self::Target {
                unsafe { core::mem::transmute(self) }
            }
        }
        windows_core::imp::interface_hierarchy!(IDStorageCompressionCodec, windows_core::IUnknown);
        ...
        impl core::ops::Deref for IDStorageCustomDecompressionQueue {
            type Target = windows_core::IUnknown;
            fn deref(&self) -> &Self::Target {
                unsafe { core::mem::transmute(self) }
            }
        ...
        impl IDStorageCustomDecompressionQueue {
            pub unsafe fn GetEvent(&self) -> windows::Win32::Foundation::HANDLE {
                (windows_core::Interface::vtable(self).GetEvent)(windows_core::Interface::as_raw(
                    self,
                ))
            }
        ...
        impl core::ops::Deref for IDStorageFactory {
            type Target = windows_core::IUnknown;
            fn deref(&self) -> &Self::Target {
                unsafe { core::mem::transmute(self) }
            }
        ...
        impl core::ops::Deref for IDStorageFile {
            type Target = windows_core::IUnknown;
            fn deref(&self) -> &Self::Target {
                unsafe { core::mem::transmute(self) }
            }
        ...
        impl core::ops::Deref for IDStorageQueue {
            type Target = windows_core::IUnknown;
            fn deref(&self) -> &Self::Target {
                unsafe { core::mem::transmute(self) }
            }
        ...
        pub struct IDStorageQueue_Vtbl {
            ...
            pub CancelRequestsWithTag: unsafe extern "system" fn(*mut core::ffi::c_void, u64, u64),
            pub Close: unsafe extern "system" fn(*mut core::ffi::c_void),
            ...
            pub Query: unsafe extern "system" fn(*mut core::ffi::c_void, *mut DSTORAGE_QUEUE_INFO),
        }
        windows_core::imp::define_interface!(
            IDStorageQueue1,
        ...
        impl IDStorageQueue1 {
            ...
            where
                P0: windows_core::Param<windows::Win32::Foundation::HANDLE>,
            {
        ...
        impl core::ops::Deref for IDStorageStatusArray {
            type Target = windows_core::IUnknown;
            fn deref(&self) -> &Self::Target {
                unsafe { core::mem::transmute(self) }
            }
        ...
        impl Default for DSTORAGE_CUSTOM_DECOMPRESSION_RESULT {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
        ...
        impl Clone for DSTORAGE_DESTINATION_MULTIPLE_SUBRESOURCES {
            fn clone(&self) -> Self {
                unsafe { core::mem::transmute_copy(self) }
            }
        }
        ...
        impl Default for DSTORAGE_DESTINATION_MULTIPLE_SUBRESOURCES {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
        ...
        impl Default for DSTORAGE_DESTINATION_TEXTURE_REGION {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
        ...
        impl Default for DSTORAGE_ERROR_PARAMETERS_EVENT {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
        ...
        pub struct DSTORAGE_ERROR_PARAMETERS_SIGNAL {
            pub Fence:
                core::mem::ManuallyDrop<Option<windows::Win32::Graphics::Direct3D12::ID3D12Fence>>,
            pub Value: u64,
        }
        impl Clone for DSTORAGE_ERROR_PARAMETERS_SIGNAL {
            fn clone(&self) -> Self {
                unsafe { core::mem::transmute_copy(self) }
            }
        }
        ...
        impl Default for DSTORAGE_ERROR_PARAMETERS_SIGNAL {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
        ...
        impl Clone for DSTORAGE_ERROR_PARAMETERS_STATUS {
            fn clone(&self) -> Self {
                unsafe { core::mem::transmute_copy(self) }
            }
        }
        ...
        impl Default for DSTORAGE_ERROR_PARAMETERS_STATUS {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
        ...
        pub struct DSTORAGE_QUEUE_DESC {
            ...
            pub Device:
                core::mem::ManuallyDrop<Option<windows::Win32::Graphics::Direct3D12::ID3D12Device>>,
        }
        impl Clone for DSTORAGE_QUEUE_DESC {
            fn clone(&self) -> Self {
                unsafe { core::mem::transmute_copy(self) }
            }
        }
        ...
        impl Default for DSTORAGE_QUEUE_DESC {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
        ...
        impl Clone for DSTORAGE_QUEUE_INFO {
            fn clone(&self) -> Self {
                unsafe { core::mem::transmute_copy(self) }
            }
        }
        ...
        impl Default for DSTORAGE_QUEUE_INFO {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
        ...
        impl Default for DSTORAGE_SOURCE_FILE {
            fn default() -> Self {
                unsafe { core::mem::zeroed() }
            }
        }
