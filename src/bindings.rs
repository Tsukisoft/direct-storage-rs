...
pub mod Microsoft {
    pub mod Direct3D {
        pub mod DirectStorage {
            ...
            {
                windows_targets::link!("dstorage" "system" fn DStorageCreateCompressionCodec(format : DSTORAGE_COMPRESSION_FORMAT, numthreads : u32, riid : *const windows_core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
            ...
            where
                T: windows_core::Interface,
            {
                windows_targets::link!("dstorage" "system" fn DStorageGetFactory(riid : *const windows_core::GUID, ppv : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
                let mut result__ = core::ptr::null_mut();
                unsafe {
            ...
            pub unsafe fn DStorageSetConfiguration(
                ...
                windows_targets::link!("dstorage" "system" fn DStorageSetConfiguration(configuration : *const DSTORAGE_CONFIGURATION) -> windows_core::HRESULT);
            ...
            pub unsafe fn DStorageSetConfiguration1(
                ...
                windows_targets::link!("dstorage" "system" fn DStorageSetConfiguration1(configuration : *const DSTORAGE_CONFIGURATION1) -> windows_core::HRESULT);
